...
# Parameters from Planck measurement from D&S Appendix B
n_s = 0.9682
A_s = 1e-10*np.exp(3.048)
k_p = 0.05 # 1/Mpc
...
omega_lambda_h2 = h**2 - omega_m_h2 - omega_rad_h2 # assumes a flat universe
